...
<div class="container">
 ...
 <div class="row mt-4">
    ...
    <div class="col-md-4">
      <div class="card mb-4 shadow-sm">
        <a href="{{ URL::to('kategori/satu') }}">
          <img src="{{asset('images/image2.jpg') }}" alt="foto kategori" class="card-img-top">
        </a>
        <div class="card-body">
  ...
  <div class="row mt-4">
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <a href="{{ URL::to('produk/satu') }}" class="text-decoration-none">
            <p class="card-text">produk makanan </p>
          </a>
          <div class="row mt-4">
            <div class="col">
    ...
    <div class="row mt-4">
    <div class="col col-md-12 col-sm-12 mb-4">
      <h2 class="text-center"> produk promo</h2>
    </div>
    ...
    <div class="col" style="text-align: center;">
      <h5 class="text-center"> admin resto</h5>
      <p class="text-center">
