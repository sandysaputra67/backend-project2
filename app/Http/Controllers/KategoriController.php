...
class KategoriController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       $data= array('title'=>'kategori','itemkategori'=>$itemkategori);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validasislug = Kategori::where('id','!=',$id)->where('slug_kategori',$slug)->first();
        if($validasislug){
            ...
            return redirect()->route('kategori.index')->with('success','data berhasil di upload');
        }
    }
